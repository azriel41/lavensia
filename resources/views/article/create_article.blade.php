                ...
                <div class="row clearfix">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                <div class="body">
                                    <form method="post" action="{{ route('article_save') }}" enctype="multipart/form-data"  accept-charset="utf-8">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-6 col-md-10 col-sm-10 col-xs-10">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" name="da_header" id="da_header" class="form-control" placeholder="Title">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-6 col-md-10 col-sm-10 col-xs-10">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" name="da_show" id="da_show" class="form-control" placeholder="Show">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <textarea id="mytextarea" name="da_desc">Hello, World!</textarea>
