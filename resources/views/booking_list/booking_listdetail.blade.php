                        ...
                        <div class="sec-sub-title text-center wow fadeInUp  animated col-sm-6" data-wow-duration="1000ms">
                            <table width="100%" class="table table-striped"> 
                                ...
                                <tr>
                                    <td align="left" class="Hightlight">Adult</td>
                                    <td>: </td>
                                    <td align="right" class="Hightlight" colspan="2">{{ number_format($data[0]->md_adult_price,0,'','.')}}</td>
                                    <td align="left" class="Hightlight">Child</td>
                                    <td>: </td>
                                    <td align="right" class="Hightlight" colspan="3">{{ number_format($data[0]->md_child_price,0,'','.')}}</td>
                                </tr>
                                <tr>
                                    <td align="left" class="Hightlight">Infant</td>
                                    <td>: </td>
                                    <td align="right" class="Hightlight" colspan="2">{{ number_format($data[0]->md_infant_price,0,'','.')}}</td>
                                    <td align="left" class="Hightlight">Child w b</td>
                                    <td>: </td>
                                    <td align="right" class="Hightlight" colspan="3">{{ number_format($data[0]->md_child_w_price,0,'','.')}}</td>
                                </tr>
                                <tr>
                                    <td align="left" class="Hightlight">Agent Com</td>
                                    <td>: </td>
                                    <td align="right" class="Hightlight" colspan="2">{{ number_format($data[0]->md_agent_com,0,'','.')}}</td>
                                    <td align="left" class="Hightlight">Tips</td>
                                    <td>: </td>
                                    <td align="right" class="Hightlight" colspan="3">{{ number_format($data[0]->md_tips,0,'','.')}}</td>
                                </tr>
                                <tr>
                                    <td align="left" class="Hightlight">Visa</td>
                                    <td>: </td>
                                    <td align="right" class="Hightlight" colspan="2">{{ number_format($data[0]->md_visa,0,'','.')}}</td>
                                    <td align="left" class="Hightlight">Visa</td>
                                    <td>: </td>
                                    <td align="right" class="Hightlight" colspan="3">{{ number_format($data[0]->md_tips,0,'','.')}}</td>
                                </tr>
