...
<!-- Favicon -->
<link rel="icon" href="{{ asset('assets_frontend_2/img/core-img/favicon.png') }}">

<!-- Core Stylesheet -->
<link href="{{ asset('assets_frontend_2/style.css') }}" rel="stylesheet">

<!-- Responsive CSS -->
<link href="{{ asset('assets_frontend_2/css/responsive/responsive.css') }}" rel="stylesheet">
