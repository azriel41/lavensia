...
<!-- Popper js -->
<script src="{{ asset('assets_frontend_2/js/bootstrap/popper.min.js') }}"></script>
<!-- Bootstrap-4 js -->
<script src="{{ asset('assets_frontend_2/js/bootstrap/bootstrap.min.js') }}"></script>
<!-- All Plugins js -->
<script src="{{ asset('assets_frontend_2/js/others/plugins.js') }}"></script>
<!-- Active JS -->
<script src="{{ asset('assets_frontend_2/js/active.js') }}"></script>
<!-- Izi toast-->
