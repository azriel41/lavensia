    ...
    <div class="wrapper">
    	<div class="wrapper-inner">
    		<table class="outer-table">
    			<tr>
    				<td class="header">
    					<p><a href="oke-trip.com"><img src="{{ asset ('assets_frontend/img/head_logo.png')}}" alt="icon" border="0" class="logo">{{-- BRILLIANT ENGLISH COURSE --}}</a></p>
    				</td>
    			</tr> <!--- End Header -->
    			...
    			<tr>
    				<td class="one-column">
    					<table width="100%">
    						<tr>
    							<td class="inner-td">
	    							 <p class="h2">MASTER AGENT PROFILE</p>
	    							 <p class="center">Hy, You got this message because you have already became membership of <b>OKE-TIP.COM</b> Tour & Travel. Here your Personal Data <br><b>Do not tell Everyone </b></p>
    							 	  <br>
	    								<table class="data">
    										<tr>
    											<td width="40%">Name</td>
    								...
    								<p class="button-holder-center">
    									<a class="btn" href="oke-trip.com">Learn more</a>
    								</p>
    							</td>
    						</tr>
    					</table>
