                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form id="save_data" method="get" accept-charset="utf-8" >
                            {{-- Hiddem --}}
                            <input type="hidden" name="ad_id" value="{{ $data->mc_id }}">
                            {{--  --}}
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-10 col-xs-10">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="ad_name" id="ad_name"  value="{{ $data->mc_name }}" class="form-control" placeholder="Name">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function update() {
        ...
        $.ajax({
            ...
            url  : ('{{ route('master_category_update') }}'),
            type : 'POST',
