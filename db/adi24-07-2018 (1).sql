...
CREATE TABLE IF NOT EXISTS `d_booking` (
  ...
  `db_status` enum('Waiting List','Holding Confirm','Hx By Agent','Hx By User') DEFAULT 'Waiting List',
...
INSERT INTO `d_booking` (`db_id`, `db_users`, `db_intinerary_id`, `db_status`, `db_name`, `db_pax`, `db_remark`, `db_total_additional`, `db_total_room`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
	(1, 1, 10, 'Waiting List', 'Sejahtera', 15, 'Check', 21900000, 101000000, '2018-07-23 14:14:32', '2018-07-23 14:14:32', 1, 1),
	(3, 1, 10, 'Waiting List', 'Kencana', 5, 'Tes', 7300000, 34000000, '2018-07-23 14:52:47', '2018-07-23 14:52:47', 1, 1),
	(4, 1, 10, 'Waiting List', 'Siskamling', 5, 'asdasd', 5380000, 35000000, '2018-07-23 14:55:47', '2018-07-23 14:55:47', 1, 1),
	(5, 1, 10, 'Waiting List', 'Tes', 3, 'asd', 2720000, 21000000, '2018-07-23 14:57:26', '2018-07-23 14:57:26', 1, 1),
	(6, 1, 11, 'Waiting List', 'Tes', 3, 'asdasd', 2260000, 36963936, '2018-07-23 14:58:28', '2018-07-23 14:58:28', 1, 1);
