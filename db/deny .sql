...
INSERT INTO `d_additonal_booking` (`da_booking_id`, `da_detail`, `da_name`, `da_price`, `da_status`, `da_additional_id`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
	...
	(5, 1, 'xx', 1000000, 'Waiting List', 1, '2018-08-09 17:42:27', '2018-08-09 17:42:27', '4', '4'),
	(6, 1, '1', 1000000, 'Waiting List', 1, '2018-08-10 17:03:06', '2018-08-10 17:03:06', '4', '4'),
	(7, 1, 'aNTO', 100000, 'Waiting List', 4, '2018-08-10 18:46:51', '2018-08-10 18:46:51', '6', '6'),
	(8, 1, 'michelle soetiktio', 1000000, 'Waiting List', 23, '2018-08-13 19:21:11', '2018-08-13 19:21:11', '4', '4'),
	(8, 2, 'VINCENTIUS CALVIN', 1000000, 'Waiting List', 23, '2018-08-13 19:21:11', '2018-08-13 19:21:11', '4', '4');
...
-- Dumping data for table lavensia.d_booking: ~7 rows (approximately)
...
INSERT INTO `d_booking` (`db_id`, `db_kode_transaksi`, `db_users`, `db_telp`, `db_intinerary_id`, `db_status`, `db_name`, `db_total_adult`, `db_total_child`, `db_total_infant`, `db_remark`, `db_total_additional`, `db_total_room`, `db_total`, `db_total_remain`, `created_at`, `updated_at`, `created_by`, `updated_by`, `db_handle_by`) VALUES
	(1, '180700001', 5, '81812323', 3, 'Waiting List', 'siti', 2, 0, 1, 'zzz', 1720000, 30000000, 31720000, 31720000, '2018-07-30 20:19:30', '2018-08-10 14:56:36', 5, 5, '4'),
	(2, '180700002', 5, '898982', 3, 'Waiting List', 'Tes', 2, 0, 0, 'ss', 1460000, 25000000, 26460000, 26460000, '2018-07-31 00:38:15', '2018-08-10 19:00:02', 5, 5, '6'),
	(3, '180800003', 5, NULL, 1, 'Waiting List', NULL, 1, 0, 1, 'sad', 1000000, 10000000, 11000000, 11000000, '2018-08-03 21:50:06', '2018-08-15 10:30:14', 5, 5, '4'),
	(4, '180800004', 5, NULL, 3, 'Waiting List', '', 1, 0, 1, 'xx', 2260000, 17500000, 19760000, 19760000, '2018-08-03 22:06:41', '2018-08-03 22:06:41', 5, 5, NULL),
	(5, '180800005', 4, '1', 10, 'Waiting List', 'ASEP HIDAYAT', 1, 0, 0, 'xxxxxxxxxxxx', 1000000, 10000000, 11000000, 11000000, '2018-08-09 17:42:27', '2018-08-09 17:42:27', 4, 4, '4'),
	(6, '180800006', 4, '81111111', 10, 'Waiting List', 'GEGE OLD', 1, 0, 0, 'xxx', 1000000, 10000000, 11000000, 11000000, '2018-08-10 17:03:06', '2018-08-10 17:03:06', 4, 4, NULL),
	(7, '180800007', 6, '122', 11, 'Waiting List', 'ANTO', 1, 0, 0, 'XXX', 100000, 5200000, 5300000, 5300000, '2018-08-10 18:46:51', '2018-08-10 18:55:31', 6, 6, '6'),
	(8, '180800008', 4, '08888888888', 13, 'Waiting List', 'CALVIN', 2, 0, 0, NULL, 2000000, 10800000, 12800000, 12800000, '2018-08-13 19:21:11', '2018-08-13 19:21:11', 4, 4, NULL);
...
INSERT INTO `d_history_bayar` (`dh_id`, `dh_booking_id`, `dh_total_payment`, `dh_payment_method`, `created_at`, `updated_at`) VALUES
	...
	(3, 5, 6000000, 'dp', '2018-08-09 21:12:14', '2018-08-09 21:12:14'),
	(4, 6, 9000000, 'dp', '2018-08-10 17:05:01', '2018-08-10 17:05:01'),
	(5, 6, 11000000, 'dp', '2018-08-10 17:06:21', '2018-08-10 17:06:21'),
	(6, 7, 3000000, 'dp', '2018-08-10 18:51:11', '2018-08-10 18:51:11');
...
INSERT INTO `d_history_bayar_d` (`dhd_id`, `dhd_history_id`, `dhd_bank`, `dhd_nominal`, `dhd_nama_rekening`, `dhd_image`, `dhd_tanggal`, `created_at`, `updated_at`) VALUES
	...
	(4, 3, '1111', 6000000, '6564', 'history_bayar/BAYAR_PERTAMA_180800005_3.jpg', '2018-08-09', '2018-08-09 21:12:15', '2018-08-09 21:12:15'),
	(5, 4, 'X', 9000000, 'X', 'history_bayar/BAYAR_PERTAMA_180800006_4.jpg', '2018-08-10', '2018-08-10 17:05:01', '2018-08-10 17:05:01'),
	(6, 5, 'X', 11000000, 'X', 'history_bayar/BAYAR_PERTAMA_180800006_5.jpg', '2018-08-10', '2018-08-10 17:06:21', '2018-08-10 17:06:21'),
	(7, 6, 'ANTO', 3000000, 'ANTO', 'history_bayar/BAYAR_PERTAMA_180800007_6.jpg', '2018-08-10', '2018-08-10 18:51:11', '2018-08-10 18:51:11');
...
INSERT INTO `d_party_name` (`dp_booking_id`, `dp_detail`, `dp_bed`, `dp_name`, `dp_passport`, `dp_exp_date`, `dp_issuing`, `dp_gender`, `dp_birth_date`, `dp_birth_place`, `dp_reference`, `dp_image`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
	...
	(5, 1, 'Single', 'XX', '1', '2018-08-09', '1', 'male', '2018-08-23', '1', '1', 'b', '2018-08-09 17:42:27', '2018-08-09 17:42:27', '4', '4'),
	(6, 1, 'Single', '1', '1', '2018-08-28', '1', 'male', '2018-08-09', '1', '1', 'b', '2018-08-10 17:03:06', '2018-08-10 17:03:06', '4', '4'),
	(7, 1, 'Single', 'ANTO', '12121212', '2018-08-01', '-', 'male', '2018-08-01', 'SURABAYA', '-', 'b', '2018-08-10 18:46:51', '2018-08-10 18:46:51', '6', '6'),
	(8, 1, 'Double', 'MICHELLE SOETIKTIO', 'x123456', '2018-08-29', 'SURABAYA', 'female', '1994-04-30', 'SURABAYA', 'XX', 'b', '2018-08-13 19:21:11', '2018-08-13 19:21:11', '4', '4'),
	(8, 2, 'Double', 'VINCENTIUS CALVIN', 'B123456', '2018-12-13', 'SURABAYA', 'male', '1997-06-18', 'SURABAYA', 'XX', 'o', '2018-08-13 19:21:11', '2018-08-13 19:21:11', '4', '4');
...
INSERT INTO `m_detail_intinerary` (`md_id`, `md_intinerary_id`, `md_detail`, `md_nota`, `md_seat`, `md_seat_remain`, `md_start`, `md_end`, `md_adult_price`, `md_child_price`, `md_infant_price`, `md_child_w_price`, `md_dp`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
	(10, 3, 1, 'LCV0818/003/001', 20, 20, '2018-08-09', '2018-08-09', 10000000, 8000000, 0, 8000000, 8000000, '2018-08-09 14:49:45', '2018-08-10 17:03:06', 'Asep Hidayat', 'Asep Hidayat'),
	(11, 4, 1, 'LCV0818/004/001', 12, 12, '2018-08-10', '2018-08-12', 5200000, 5000000, 0, 4000000, 3000000, '2018-08-10 18:40:38', '2018-08-10 18:46:51', 'DENY PRASETYO', 'DENY PRASETYO'),
	(12, 1, 1, 'LCV0818/001/001', 1, 1, '2018-08-13', '2018-08-13', 1, 1, 1, 1, 1, '2018-08-13 17:41:02', '2018-08-13 17:41:02', 'Asep Hidayat', 'Asep Hidayat'),
	(13, 2, 1, 'LCV0818/002/001', 21, 21, '2018-08-31', '2018-09-03', 5400000, 4900000, 2000000, 5400000, 3000000, '2018-08-13 19:02:20', '2018-08-13 19:21:11', 'Asep Hidayat', 'Asep Hidayat');
...
INSERT INTO `m_intinerary` (`mi_id`, `mi_nota`, `mi_name`, `mi_term`, `category_id`, `mi_image`, `mi_pdf`, `mi_highlight`, `mi_by`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
	(1, 'LCV0818/001', 'x', 'xxx', 1, 'itinerary/PHOTO_LCV0818-001.jpg', 'itinerary/PDF_LCV0818-001.png', 'XX', 'XX', '2018-08-13 17:41:02', '2018-08-13 17:41:02', 'Asep Hidayat', 'Asep Hidayat'),
	(2, 'LCV0818/002', '4D BANGKOK-PATTAYA', 'xx', 1, 'itinerary/PHOTO_LCV0818-002.png', 'itinerary/PDF_LCV0818-002.pdf', 'WAT ARUN, SILVER LAKE', 'ROYAL BRUNEI', '2018-08-13 19:02:20', '2018-08-13 19:02:20', 'Asep Hidayat', 'Asep Hidayat');
...
-- Dumping data for table lavensia.m_schedule: ~24 rows (approximately)
...
INSERT INTO `m_schedule` (`ms_intinerary_id`, `ms_detail`, `ms_caption`, `ms_description`, `ms_bld`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
	(1, 1, '1', '1', '1', '2018-08-13 17:41:02', '2018-08-13 17:41:02', 'Asep Hidayat', 'Asep Hidayat'),
	(2, 1, 'SURABAYA - BANGKOK', 'Berkumpul di Juanda', 'b & l ON BOARD', '2018-08-13 19:02:20', '2018-08-13 19:02:20', 'Asep Hidayat', 'Asep Hidayat'),
	(2, 2, 'BANGKOK - SURABAYA', 'Kembali ke Surabaya', 'b / l & d on board', '2018-08-13 19:02:20', '2018-08-13 19:02:20', 'Asep Hidayat', 'Asep Hidayat'),
	(3, 1, 'SURABAYA – BRUNEI – BANGKOK', 'Berkumpul di Juanda International Airport untuk berangkat bersama menuju Bangkok (via Brunei). Sesampainya di Brunei, mengunjungi Royal Regalia Museum, Omar Ali Saifuddin Mosque, Jame Asr Bolkiah Mosque, dan The Mall Brunei. Setelah itu pengantaran kembali ke Brunei Airport untuk penerbangan menuju ke Bangkok. Setibanya di Bangkok menuju ke hotel untuk check in.', 'B on board', '2018-08-09 14:49:45', '2018-08-09 14:49:45', 'Asep Hidayat', 'Asep Hidayat'),
	(3, 2, 'BANGKOK', 'Hari ini acara bebas yang dapat anda gunakan untuk berdoa di 4 Face Buddha untuk merayakan ulang tahunnya, setelah itu kita dapat berbelanja di Platinum Mall dekat hotel', 'B fast hotel', '2018-08-09 14:49:45', '2018-08-09 14:49:45', 'Asep Hidayat', 'Asep Hidayat'),
	(3, 3, 'BANGKOK – PATTAYA', 'Setelah makan pagi, kita akan menuju Wat Arun untuk berbelanja barang barang khas Thailand. Tidak lupa untuk mengunjungi Golden Buddha dimana terdapat Patung Buddha terbesar di dunia dengan  berat 5,5 Ton. Perjalanan dilanjutkan menuju Pattaya. Setibanya di Pattaya kita akan mengunjungi Sanctuary of Truth dimana kita dapat berdoa disana. Dan singgah di Bee Farm, setelah itu makan malam dan check in hotel.', 'B / L / D', '2018-08-09 14:49:45', '2018-08-09 14:49:45', 'Asep Hidayat', 'Asep Hidayat'),
	(4, 1, 'SURABAYA – BANGKOK', 'Berkumpul di Juanda International Airport untuk berangkat bersama menuju Suvarnabhumi Airport Bangkok. Setibanya di Bangkok, anda diajak berwisata di Wat Arun dengan menggunakan ferry menyusuri sungai Chaopraya, kuil terkenal di Thailand dan didalamnya terdapat pasar terbuka dengan souvenir khas Thailand yang terkenal sangat murah. Lalu anda diajak berbelanja di Platinum Mall (Mangga Dua-nya Bangkok) dan berdoa di Four Faces Buddha ( bagi yang berminat ). Lalu berwisata kuliner khas Thailand di Asiatique Night Market. Setelah itu check-in hotel untuk beristirahat.', 'B & L on board', '2018-08-10 18:40:38', '2018-08-10 18:40:38', 'DENY PRASETYO', 'DENY PRASETYO'),
	(4, 2, 'BANGKOK – SURABAYA', 'Setelah makan pagi, diajak berkunjung dan berbelanja cokelat di Chocolate Factory hingga tiba saatnya untuk diantar menuju ke bandara dan kembali ke Surabaya. Sampai bertemu di lain kesempatan…', 'B & L ON BOARD', '2018-08-10 18:40:38', '2018-08-10 18:40:38', 'DENY PRASETYO', 'DENY PRASETYO'),
