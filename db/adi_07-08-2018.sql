...
-- Dumping data for table lavensia.d_additonal_booking: ~9 rows (approximately)
...
-- Dumping data for table lavensia.d_history_bayar_d: ~3 rows (approximately)
...
REPLACE INTO `m_detail_intinerary` (`md_id`, `md_intinerary_id`, `md_detail`, `md_nota`, `md_seat`, `md_seat_remain`, `md_start`, `md_end`, `md_adult_price`, `md_child_price`, `md_infant_price`, `md_child_w_price`, `md_dp`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
	(3, 2, 1, 'TR0718/002/001', 10, 10, '2018-07-18', '2018-07-31', 12500000, 10000000, 5000000, 12500000, NULL, '2018-07-30 20:01:54', '2018-08-03 22:06:41', 'adi', 'adi'),
