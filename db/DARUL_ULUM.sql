...
-- Dumping data for table darul_ulum.d_daftar_menu: ~14 rows (approximately)
...
-- Dumping data for table darul_ulum.d_group_akun: ~1 rows (approximately)
...
-- Dumping data for table darul_ulum.d_jurnal_dt: ~4 rows (approximately)
...
-- Dumping data for table darul_ulum.d_petty_cash_detail: ~3 rows (approximately)
