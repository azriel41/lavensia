...
-- Dumping data for table lavensia.d_additonal_booking: ~77 rows (approximately)
...
-- Dumping data for table lavensia.d_party_name: ~28 rows (approximately)
/*!40000 ALTER TABLE `d_party_name` DISABLE KEYS */;
REPLACE INTO `d_party_name` (`dp_booking_id`, `dp_detail`, `dp_fam_name`, `dp_name`, `dp_price`, `dp_bed`, `dp_image`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
