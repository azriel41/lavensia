...
-- Dumping data for table lavensia.d_booking: ~0 rows (approximately)
/*!40000 ALTER TABLE `d_booking` DISABLE KEYS */;
INSERT INTO `d_booking` (`db_id`, `db_users`, `db_telp`, `db_intinerary_id`, `db_status`, `db_name`, `db_total_adult`, `db_total_child`, `db_total_infant`, `db_remark`, `db_total_additional`, `db_total_room`, `db_total`, `db_total_remain`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
	...
	(2, 4, 999999922, 1, 'Holding Confirm', 'lolololol', 3, 0, 0, NULL, 2000000, 30000000, 32000000, 32000000, '2018-07-30 16:51:12', '2018-07-30 16:51:44', 4, 4);
